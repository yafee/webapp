...
// });
// function initTable() {
//    var table= $('#focus_logTable').DataTable({
//         ajax: {
//             url: "js/json/focus_log.txt"
//         },
...
//         if (jsonobject.isFocus == "true") {
//             $("#is_focus").attr("checked", "true")
//         } else {
//             $("#isnot_focus").attr("checked", "true")
//         }
//     }
// }
...
//     var jsonobject = eval('(' + rowcontent + ')');
//     var jsonobj1 = {};
//     var jsonObject = $('#focus_logform').serializeArray();
...
$(function() {
  ...
  new DataTable(
    ...
    'returnData', ['userName', 'dealName', 'createTime'],
    '/delete',
    '/update',
    '/add'
  );
